export type Result<T, TError extends {
    code: string;
    message: string;
} = RouterError> = {
    ok: true;
...
export type RouterErrorCode = "INVALID_REQUEST" | "WITHIN_NOT_FOUND" | "OUTSIDE_ALLOWED_SCOPE" | "WORKER_UNAVAILABLE" | "WORKER_LIMIT_REACHED" | "SEARCH_FAILED" | "DEADLINE_EXCEEDED" | "CURSOR_INVALID" | "CURSOR_EXPIRED" | "DAEMON_START_FAILED" | "DAEMON_UNAVAILABLE" | "INTERNAL_ERROR" | "SEARCH_PATH_NOT_ABSOLUTE" | "SEARCH_PATH_NOT_FOUND" | "SEARCH_PATH_REALPATH_FAILED";
